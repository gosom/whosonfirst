...
function assignField(hierarchyElement, wofDoc) {
  switch (hierarchyElement.place_type) {
    case 'locality':
      ...
      break;
    case 'borough':
      wofDoc.addParent('borough', hierarchyElement.name, hierarchyElement.id.toString());
      break;
    case 'localadmin':
    ...
    case 'county':
      ...
      break;
    case 'macrocounty':
      wofDoc.addParent('macrocounty', hierarchyElement.name, hierarchyElement.id.toString());
      break;
    case 'region':
      ...
      break;
    case 'macroregion':
      wofDoc.addParent('macroregion', hierarchyElement.name, hierarchyElement.id.toString());
      break;
    case 'country':
